...
int main(){
    ...
    for(i=0; i<nEntregas; i++){
        ...
        // Coloca a distância da entrega para o entregador em cada elemento respectivo na matriz

        distancia[i] = distancia[i] * 0.621371192; // Converte a distância de radianos para metros

        printf("%llf m \n", distancia[i]); // print que fiz só pra testar
    }
